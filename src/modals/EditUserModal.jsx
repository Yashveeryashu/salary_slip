...
const EditUserModal = ({ showModal, closeModal, emp }) => {
  ...
  const handelReset = (e) => {
    ...
    setSelectedUser({
      ...
      workingLocation: emp?.workingLocation,
      employeeNo: emp?.employeeNo,
      totalSalary: emp?.totalSalary,
    });
    setNotMedFields({ client: emp.client, dob: emp.dob });
  };
    ...
    >
      {loading ? (
        ...
        <div className="p-2 relative">
          ...
          <p className="text-center text-2xl">Edit Employee</p>
          <form className="grid grid-cols-2 gap-4 mt-6" onReset={handelReset}>
            ...
            <div className="grid grid-cols-3 gap-4 items-center">
              <label htmlFor="totalSalary">Salary:</label>
              <input
                className="col-span-2"
                type="number"
                name="totalSalary"
